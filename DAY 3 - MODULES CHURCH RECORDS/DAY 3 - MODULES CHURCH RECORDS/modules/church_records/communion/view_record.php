<?php
// church/modules/church_records/communion/view_record.php
// Communion Module: View a single communion record
...
$prev_rec = $conn->query("
    SELECT id, name FROM communion_records
...
$page_title = htmlspecialchars($rec['name']) . ' — Communion Record';
...
<style>
    ...
    .record-hero::after { content:attr(data-recno);position:absolute;right:24px;top:50%;transform:translateY(-50%);font-family:'Playfair Display',serif;font-size:4.5rem;font-weight:700;color:rgba(255,255,255,0.05);pointer-events:none;letter-spacing:-2px;white-space:nowrap; }
    ...
    .hero-record-no { display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,0.12);color:#d1fae5;font-size:0.75rem;font-weight:600;padding:3px 10px;border-radius:6px;font-family:monospace;flex-shrink:0; }
    ...
    .act-btn-pink { background:#059669;color:#fff; }
    .act-btn-pink:hover { background:#047857; }
    ...
    .record-nav-btn:hover { border-color:#059669;color:#059669;background:#f0fdf4; }
...
<div class="page-header" style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
    <div class="page-header-left">
        <h1><i class="fas fa-bread-slice" style="color:#059669;margin-right:8px;font-size:1rem;"></i>Communion Record</h1>
        <p class="breadcrumb">
    ...
    <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        <a href="/church/modules/church_records/communion/print_certificate.php?id=<?= $id ?>"
        ...
        <a href="/church/modules/church_records/communion/edit_record.php?id=<?= $id ?>"
...
<div style="padding:24px 24px 60px;">
    ...
    <div class="record-nav">
        <a href="<?= $prev_rec ? '/church/modules/church_records/communion/view_record.php?id=' . $prev_rec['id'] : '#' ?>"
        ...
        <a href="<?= $next_rec ? '/church/modules/church_records/communion/view_record.php?id=' . $next_rec['id'] : '#' ?>"
        ...
        <div>
            ...
            <div class="record-hero" data-recno="<?= htmlspecialchars($rec['record_no']) ?>">
                <div style="display:flex;align-items:center;gap:18px;flex:1;min-width:0;">
                    ...
                    <div style="min-width:0;">
                        ...
                        <div class="hero-meta">
                            <?php if ($rec['date_of_communion']): ?>
                            <span><i class="fas fa-calendar" style="font-size:0.65rem;margin-right:3px;"></i><?= date('F j, Y', strtotime($rec['date_of_communion'])) ?></span>
                            <span style="color:rgba(255,255,255,0.2);">·</span>
                            <?php endif; ?>
                            <span><?= $year ?> Communion Series</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="detail-card">
                <div class="detail-card-header">
                    <div class="detail-card-header-icon" style="background:#f0fdf4;color:#059669;"><i class="fas fa-hashtag"></i></div>
                ...
                <div class="detail-card-body">
                    <div class="detail-grid">
                        <div class="detail-field">
                            ...
                            <span class="detail-value" style="font-family:monospace;color:#059669;">
                        ...
                        <div class="detail-field">
                            <span class="detail-label">Date of Communion</span>
                            <span class="detail-value">
                                <?= $rec['date_of_communion'] ? date('F j, Y', strtotime($rec['date_of_communion'])) : '<span class="detail-value empty">Not set</span>' ?>
                            </span>
                        </div>
                        <div class="detail-field">
            ...
            <div class="detail-card">
                <div class="detail-card-header">
                    <div class="detail-card-header-icon" style="background:#f0fdf4;color:#059669;"><i class="fas fa-users"></i></div>
                    <div class="detail-card-title">Communicant & Parents</div>
                </div>
                <div class="detail-card-body">
                ...
                <div class="detail-card-body" style="padding:16px;">
                    ...
                    <div class="doc-preview-wrap">
                        ...
                        <a href="<?= htmlspecialchars($rec['document_path']) ?>" target="_blank">
                            <img src="<?= htmlspecialchars($rec['document_path']) ?>" alt="Communion record scan"
        ...
        <div style="display:flex;flex-direction:column;gap:16px;" id="viewSidebar">
            <div style="background:#fff;border:1px solid #ede8de;border-radius:14px;padding:16px 18px;">
                ...
                <div style="display:flex;flex-direction:column;gap:8px;">
                    <a href="/church/modules/church_records/communion/print_certificate.php?id=<?= $id ?>"
                       class="act-btn act-btn-pink" target="_blank" style="justify-content:center;">
            ...
            <div style="background:#fff;border:1px solid #ede8de;border-radius:14px;padding:16px 18px;">
                ...
                <div class="info-row"><span class="info-row-label">Record No.</span><span class="info-row-value" style="font-family:monospace;color:#059669;"><?= $rec['record_no'] ? htmlspecialchars($rec['record_no']) : '—' ?></span></div>
            ...
            <a href="/church/modules/church_records/communion/series_records.php?year=<?= $year ?>"
               ...
               onmouseout="this.style.borderColor='#ede8de';this.style.color='#6b7280'">
                <i class="fas fa-arrow-left" style="font-size:0.7rem;color:#059669;"></i>
                Back to <?= $year ?> Series
            </a>
        </div>
    </div>
...
<form id="archiveForm" method="POST" action="/church/modules/archive/archive_record.php">
    ...
    <input type="hidden" name="ref_type"     value="communion">
    <input type="hidden" name="ref_id"       value="<?= $id ?>">
    <input type="hidden" name="redirect_url" value="/church/modules/church_records/communion/view_record.php?id=<?= $id ?>">
</form>
<?php endif; ?>
