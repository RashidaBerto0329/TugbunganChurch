<?php
// church/modules/church_records/baptism/print_certificate.php
// Phase 4 — Step 4.8: Printable Baptismal Certificate
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media print {
            ...
            .screen-only-notice { display: none !important; }
...
<div class="screen-toolbar">
    ...
    <div style="display:flex;gap:8px;align-items:center;">
        ...
        <button onclick="window.location.href='/church/modules/church_records/shared/download_pdf.php?type=baptism&id=<?= $id ?>'" class="toolbar-btn btn-navy">
            <i class="fas fa-file-pdf"></i> Save as PDF
        </button>
    </div>
</div>

<!-- ── Claim policy notice (screen only) ────────────────── -->
<div style="width:100%;max-width:820px;background:#fffbeb;border:1px solid #fde68a;
            border-radius:10px;padding:12px 18px;margin-bottom:16px;
            display:flex;align-items:flex-start;gap:12px;"
     class="screen-only-notice">
    <i class="fas fa-triangle-exclamation" style="color:#d97706;font-size:1rem;margin-top:1px;flex-shrink:0;"></i>
    <div>
        <p style="font-size:0.82rem;font-weight:600;color:#92400e;margin-bottom:3px;">
            Certificate Release Policy
        </p>
        <p style="font-size:0.76rem;color:#b45309;line-height:1.55;">
            This certificate may only be released to the <strong>requesting person themselves</strong>.
            If claimed by another person, a <strong>notarized authorization letter</strong> is required.
        </p>
    </div>
</div>
...
<div class="certificate-page">
    ...
    <!-- Corner ornaments (SVG fleur-de-lis style) -->
    <?php
    ...
    <!-- Watermark -->
    <div class="cert-watermark">BAPTISM</div>
    ...
    <div class="cert-inner">
        ...
        <div class="cert-divider">
            ...
            <div class="cert-divider-icon"><i class="fas fa-cross"></i></div>
            <div class="cert-divider-line"></div>
        </div>
        ...
        <div class="cert-details">
            <div class="cert-detail-row">
                ...
                <div class="cert-detail-item">
                    <span class="cert-detail-label">Place of Birth</span>
                    <span class="cert-detail-value <?= empty($rec['place_of_birth']) ? 'empty' : '' ?>">
                        <?= fmt_val($rec['place_of_birth']) ?>
                    </span>
                </div>

                <div class="cert-detail-item">
                    <span class="cert-detail-label">Date of Baptism</span>
                    <span class="cert-detail-value <?= !$rec['date_of_baptism'] ? 'empty' : '' ?>">
                        <?= $baptism_date ?>
                    </span>
                </div>
                ...
                <div class="cert-detail-item">
                    <span class="cert-detail-label">Godfather (Ninong)</span>
                    <span class="cert-detail-value <?= empty($rec['godfather']) ? 'empty' : '' ?>">
                        <?= fmt_val($rec['godfather']) ?>
                    </span>
                </div>

                <div class="cert-detail-item">
                    <span class="cert-detail-label">Godmother (Ninang)</span>
                    <span class="cert-detail-value <?= empty($rec['godmother']) ? 'empty' : '' ?>">
                        <?= fmt_val($rec['godmother']) ?>
                    </span>
                </div>

                <div class="cert-detail-item" style="grid-column:span 2;">
                    <span class="cert-detail-label">Parents' Address</span>
                ...
                ?>
                <div class="cert-detail-item" style="grid-column:span 2;">
                    <span class="cert-detail-label">Kind of Marriage of Parents</span>
                    <span class="cert-detail-value <?= empty($marriage_display) ? 'empty' : '' ?>">
                        <?= $marriage_display ?: '<span class="empty">—</span>' ?>
                    </span>
                </div>
        ...
        <div class="cert-signatures">
            ...
            <div class="cert-sig-block">
                ...
                <div class="cert-sig-name">
                    <?= $rec['minister'] ? htmlspecialchars($rec['minister']) : 'Parish Priest' ?>
                </div>
