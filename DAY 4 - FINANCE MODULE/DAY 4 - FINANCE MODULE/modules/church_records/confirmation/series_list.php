<?php
// church/modules/church_records/confirmation/series_list.php
// Phase 4 — Step 4.9: Confirmation series list
...
$series_sql = "
    SELECT
        ...
        MIN(cr.date_of_confirmation)        AS first_date,
        MAX(cr.date_of_confirmation)        AS last_date,
    ...
    FROM confirmation_series cs
    LEFT JOIN confirmation_records cr
...
<style>
    ...
    .current-year-tag {
        ...
        background: rgba(224,192,255,0.2); color: #e0c0ff;
    ...
    .series-card:hover .series-open-btn { background: #8b5cf6; color: #fff; }
    ...
    .series-card-new:hover { border-color: #8b5cf6; background: #f5f3ff; }
    ...
    .series-card-new:hover .series-card-new-icon { background: #ede9fe; color: #8b5cf6; }
    .series-card-new-title {
        font-family: 'Playfair Display', serif; font-size: 0.95rem;
        font-weight: 600; color: #9ca3af; transition: color 0.2s;
    }
    .series-card-new:hover .series-card-new-title { color: #8b5cf6; }
    .series-card-new p {
    ...
    .btn-submit {
        ...
        font-weight: 600; background: #7c3aed; color: #fff; border: none;
    ...
    @media (max-width: 640px) {
        ...
        .confirmation-banner { flex-direction: column; align-items: flex-start; gap: 0; padding: 20px; }
...
<div style="padding:24px 24px 60px;">
    ...
    <p style="font-family:'Playfair Display',serif;font-size:0.88rem;font-weight:600;
        ...
        <i class="fas fa-layer-group" style="color:#8b5cf6;font-size:0.8rem;"></i>
        Year Series
    </p>
    <p style="font-size:0.78rem;color:#9ca3af;margin-bottom:18px;">
        Each year contains its own set of confirmation records. Click a series to view or add entries.
    </p>

    <?php if (empty($series_list)): ?>
    <div style="background:#fff;border:1px solid #ede8de;border-radius:14px;
                text-align:center;padding:60px 24px;">
        <div style="width:72px;height:72px;border-radius:20px;background:#f5f3ff;
                    display:flex;align-items:center;justify-content:center;
                    margin:0 auto 20px;color:#8b5cf6;font-size:2rem;">
            <i class="fas fa-dove"></i>
        </div>
        ...
        <p style="font-size:0.85rem;color:#9ca3af;margin-bottom:24px;
            ...
            Create your first year series to start adding confirmation records.
        </p>
        <?php if (in_array($current_user_role, ['admin', 'clergy'])): ?>
        <button onclick="openModal()"
            ...
            <a href="/church/modules/church_records/confirmation/series_records.php?year=<?= $year ?>"
               class="series-card">
                <div class="series-card-head" data-year="<?= $year ?>">
                    ...
                    <div class="series-sub-label">Confirmation Series</div>
                    <?php if ($is_current): ?>
...
<div class="modal-overlay" id="addSeriesModal">
    <div class="modal-box">
        ...
        <form method="POST" action="/church/modules/church_records/confirmation/add_series.php">
            <div class="modal-body">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <textarea name="notes" class="form-input" rows="3"
                              placeholder="e.g. Includes special confirmation ceremony from the Bishop's visit…"
...
<div class="modal-overlay" id="editSeriesModal">
    <div class="modal-box">
        ...
        <form method="POST" action="/church/modules/church_records/confirmation/edit_series.php">
            <div class="modal-body">
            ...
            <div class="modal-footer" style="justify-content:space-between;align-items:center;">
                <button type="submit" name="action" value="delete"
                        ...
                        onclick="return confirm('Are you sure you want to remove this series? It must have no confirmation records.');">
