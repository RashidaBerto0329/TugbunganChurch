<?php
// church/modules/church_records/baptism/series_list.php
...
$series_sql = "
    SELECT
        ...
        MIN(br.date_of_baptism)             AS first_date,
        MAX(br.date_of_baptism)             AS last_date,
        MAX(br.created_at)                  AS last_updated,
        COUNT(CASE WHEN br.document_path IS NOT NULL
                    AND br.document_path != '' THEN 1 END) AS scanned_count
    FROM baptism_series bs
    LEFT JOIN baptism_records br
        ON br.series_year = bs.series_year AND br.is_archived = 0
    GROUP BY bs.series_year, bs.notes
    ORDER BY bs.series_year DESC
";
$series_list = [];
...
<style>
    ...
    .current-year-tag {
        ...
        background: rgba(224,192,96,0.2); color: #e0c060;
    ...
    .series-card:hover .series-open-btn { background: #3b82f6; color: #fff; }
    ...
    .series-card-new:hover { border-color: #3b82f6; background: #eff6ff; }
    ...
    .series-card-new:hover .series-card-new-icon { background: #dbeafe; color: #3b82f6; }
    .series-card-new-title {
        font-family: 'Playfair Display', serif; font-size: 0.95rem;
        font-weight: 600; color: #9ca3af; transition: color 0.2s;
    }
    .series-card-new:hover .series-card-new-title { color: #3b82f6; }
    .series-card-new p {
    ...
    /* Stats — extracted to classes so media query can target them */
    .banner-stats {
        display: flex;
        gap: 28px;
        align-items: center;
    ...
    @media (max-width: 640px) {
        ...
        /* Stats: full-width horizontal row below the title */
        .banner-stats {
            width: 100%;
            gap: 0;
            margin-top: 16px;
        ...
        /* Hide vertical pipe dividers — spacing does the job */
...
<div class="page-header" style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
    <div class="page-header-left">
        ...
        <p class="breadcrumb">
            ...
            <span style="margin:0 6px;color:#d1c9b8;">›</span>
            <span class="current">Baptism</span>
        </p>
    </div>
...
<div style="padding:24px 24px 60px;">
    ...
    <div class="baptism-banner">
        ...
        <!-- Stats: always horizontal, across all screen sizes -->
    ...
    <p style="font-family:'Playfair Display',serif;font-size:0.88rem;font-weight:600;
        ...
        <i class="fas fa-layer-group" style="color:#3b82f6;font-size:0.8rem;"></i>
        Year Series
    </p>
    <p style="font-size:0.78rem;color:#9ca3af;margin-bottom:18px;">
        Each year contains its own set of baptism records. Click a series to view or add entries.
    </p>
    ...
    <div style="background:#fff;border:1px solid #ede8de;border-radius:14px;
        ...
        <div style="width:72px;height:72px;border-radius:20px;background:#eff6ff;
                    display:flex;align-items:center;justify-content:center;
        ...
        <p style="font-size:0.85rem;color:#9ca3af;margin-bottom:24px;
            ...
            Create your first year series to start adding baptism records.
        </p>
        <?php if (in_array($current_user_role, ['admin', 'clergy'])): ?>
        <button onclick="openModal()"
            ...
            <a href="/church/modules/church_records/baptism/series_records.php?year=<?= $year ?>"
               class="series-card">
                <div class="series-card-head" data-year="<?= $year ?>">
                    ...
                    <div class="series-sub-label">Baptism Series</div>
                    <?php if ($is_current): ?>
...
<div class="modal-overlay" id="addSeriesModal">
    <div class="modal-box">
        ...
        <form method="POST" action="/church/modules/church_records/baptism/add_series.php">
            <div class="modal-body">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <textarea name="notes" class="form-input" rows="3"
                              placeholder="e.g. Includes special baptism ceremony records from Holy Week..."
        ...
        <form method="POST" action="/church/modules/church_records/baptism/edit_series.php">
            ...
            <div class="modal-footer" style="justify-content:space-between;align-items:center;">
                <button type="submit" name="action" value="delete"
                        ...
                        onclick="return confirm('Are you sure you want to remove this series? It must have no baptism records.');">
